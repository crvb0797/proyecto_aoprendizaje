 ...
 * @endcode
 */
$settings['hash_salt'] = 'ut6m2Y_QJpDE9lhS9uN6JmN4M7zOKm9OIJD3gZgnCRSMK2AD-kYU9_CLvhidXXxH0J4k3okAZQ';
...
$databases['default']['default'] = array (
  'database' => 'alimentos_y_bebidas_agexport',
  'username' => 'root',
  'password' => '',
  'prefix' => 'drupal_',
  'host' => 'localhost',
...
$settings['config_sync_directory'] = 'sites/default/files/config_SUgXq_Bi9p-J3d6a-XedI__KV9D3nOG1d7RV5K-86i1-KgcIs3LpoLMrLRVj8vXCMOSJjHI6mg/sync';
 if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
   include $app_root . '/' . $site_path . '/settings.local.php';
}